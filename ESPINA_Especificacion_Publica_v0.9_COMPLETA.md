...
> Nota: los comandos anteriores fueron **reejecutados el 2026-07-28**
> contra las mismas URLs públicas; los resultados coinciden.
> El resultado de GitHub raw (`text/plain` para `.json`) se acepta conforme a §5.3.1.
